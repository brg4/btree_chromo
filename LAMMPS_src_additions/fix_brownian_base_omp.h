...
#ifndef LMP_FIX_BROWNIAN_BASE_OMP_H
#define LMP_FIX_BROWNIAN_BASE_OMP_H
...
class FixBrownianBaseOMP : public Fix, public ThrOMP {
 public:
  FixBrownianBaseOMP(class LAMMPS *, int, char **);
  ~FixBrownianBaseOMP() override;
  void init() override;
