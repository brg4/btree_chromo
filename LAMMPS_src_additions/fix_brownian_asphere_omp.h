...
#ifdef FIX_CLASS
// clang-format off
FixStyle(brownian/asphere/omp,FixBrownianAsphereOMP);
// clang-format on
#else

#ifndef LMP_FIX_BROWNIAN_ASPHERE_OMP_H
#define LMP_FIX_BROWNIAN_ASPHERE_OMP_H
...
class FixBrownianAsphereOMP : public FixBrownianBaseOMP {
 public:
  FixBrownianAsphereOMP(class LAMMPS *, int, char **);
